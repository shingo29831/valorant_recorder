...
class Config:
    def __init__(self):
        ...
        self.RECORD_AUDIO_MIC_PREPROCESS = os.environ.get("RECORD_AUDIO_MIC_PREPROCESS", "SpeexDSP")
    ...
    def save(self):
        ...
        set_key(self.env_file, "RECORD_AUDIO_MIC_PREPROCESS", str(self.RECORD_AUDIO_MIC_PREPROCESS))
