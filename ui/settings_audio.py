from PyQt6.QtWidgets import (QWidget, QFormLayout, QComboBox, QSlider, 
...
class AudioSettingsWidget(QWidget):
    def __init__(self, config, t, parent=None):
        ...
        layout.addRow(self.t.system_gain, sys_gain_layout)
        layout.addRow(self.t.system_level, self.system_volume_meter)
